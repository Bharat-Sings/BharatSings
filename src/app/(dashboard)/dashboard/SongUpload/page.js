...
function UploadPage() {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Uploading Submissions Data:', formData);
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="flex flex-wrap gap-x-6 gap-y-3">
              {genres.map((genre) => (
                <label key={genre} className="inline-flex items-center space-x-2 text-sm text-gray-700 cursor-pointer select-none">
                  <input
                    type="checkbox"
